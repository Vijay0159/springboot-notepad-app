...
<head>
    ...
    <style>
        ...
        .delete-wrapper input[type="number"] {
            width: 100%;
            padding: 10px;
            font-size: 14px;
...
<div class="delete-wrapper">
    <h2>🗑️ Delete Note by ID</h2>

    <c:if test="${not empty error}">
        <p class="error">${error}</p>
    </c:if>

    <form class="form-card" action="/note/delete/by-id" method="post">
        <label for="noteId">Enter the ID of the note to delete:</label>
